...
@Component({
  selector: 'app-modal-productos-bodega-interno',
  templateUrl: './modal-productos-bodega-interno.component.html',
  styleUrls: ['./modal-productos-bodega-interno.component.scss']
})
export class ModalProductosBodegaInternoComponent implements OnInit {
